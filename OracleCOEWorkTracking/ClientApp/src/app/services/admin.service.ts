...
export class AdminService {
  ...
  private _urls = {
    ...
    getApplicationAttributeViews: 'api/admin/GetApplicationAttributeViews'
  };
  ...
  getApplicationAttributeViews(): Observable<ServiceCallResult<ApplicationAttribute[]>> {
    return this.http.get<ServiceCallResult<ApplicationAttribute[]>>(this._urls.getApplicationAttributeViews, { withCredentials: true });
  }
}
