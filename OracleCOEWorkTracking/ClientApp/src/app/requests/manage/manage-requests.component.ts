 ...
 displayFieldCss(field: string) {
  ...
  public createFormGroup(dataItem: Request): FormGroup {
    ...
    var returnDataItem = this.formBuilder.group({
      ...
      oraclePreProdEnvironments: new FormControl(dataItem.oraclePreProdEnvironments.filter(n => n.applicationId == dataItem.applicationId)),
  ...
  private convertForm(fg: FormGroup, requestId: number): Request {
    ...
    let request: Request = ({
      ...
      oraclePreProdEnvironments: formJson.oraclePreProdEnvironments.filter(n => n.applicationId == formJson.applicationId), 
