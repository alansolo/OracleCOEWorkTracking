...
import { ApplicationAttribute } from '../../models/application-attribute';
...
export class RequestEditModalComponent implements OnInit {
  ...
  applicationAttributesRequest: Array<ApplicationAttribute>;
  applicationAttribute: ApplicationAttribute;

  attributeDes1: string;
  attributeDes2: string;
  attributeDes3: string;
  attributeDes4: string;
  attributeDes5: string;
  attributeDes6: string;
  attributeDes7: string;
  attributeDes8: string;
  attributeDes9: string;
  attributeDes10: string;
  ...
  ngOnInit() {
    ...
    this.adminService.getApplicationAttributeViews().subscribe(callResult => {
      this.applicationAttributes = callResult.result;
      this.applicationAttributesRequest = this.applicationAttributes.filter(x => x.applicationId === this.Request.applicationId);

      if (this.applicationAttributesRequest.length > 0) {
        this.applicationAttribute = this.applicationAttributesRequest[0];

        this.attributeDes1 = this.applicationAttribute.attribute1;
        this.attributeDes2 = this.applicationAttribute.attribute2;
        this.attributeDes3 = this.applicationAttribute.attribute3;
        this.attributeDes4 = this.applicationAttribute.attribute4;
        this.attributeDes5 = this.applicationAttribute.attribute5;
        this.attributeDes6 = this.applicationAttribute.attribute6;
        this.attributeDes7 = this.applicationAttribute.attribute7;
        this.attributeDes8 = this.applicationAttribute.attribute8;
        this.attributeDes9 = this.applicationAttribute.attribute9;
        this.attributeDes10 = this.applicationAttribute.attribute10;
      }
      else {
        this.attributeDes1 = "ATTRIBUTE1";
        this.attributeDes2 = "ATTRIBUTE2";
        this.attributeDes3 = "ATTRIBUTE3";
        this.attributeDes4 = "ATTRIBUTE4";
        this.attributeDes5 = "ATTRIBUTE5";
        this.attributeDes6 = "ATTRIBUTE6";
        this.attributeDes7 = "ATTRIBUTE7";
        this.attributeDes8 = "ATTRIBUTE8";
        this.attributeDes9 = "ATTRIBUTE9";
        this.attributeDes10 = "ATTRIBUTE10";
      }
    });
    ...
    this.editRequestForm = this.formBuilder.group({
      ...
      attachments: [null],
      attributeDes1: [this.attributeDes1],
      attributeDes2: [this.attributeDes2],
      attributeDes3: [this.attributeDes3],
      attributeDes4: [this.attributeDes4],
      attributeDes5: [this.attributeDes5],
      attributeDes6: [this.attributeDes6],
      attributeDes7: [this.attributeDes7],
      attributeDes8: [this.attributeDes8],
      attributeDes9: [this.attributeDes9],
      attributeDes10: [this.attributeDes10]
    });
...
//  }
  ...
  public ValidMD70DueDate() {
    ...
    if (formJson.mD_50_DueDate.toDateString() === "month/day/year") {
      return false;
    }
    else
    {
